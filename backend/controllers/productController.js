...
// Get all products
export const getProducts = asyncMiddleware(async (req, res, next) => {
  const resPerPage = 8;
...
// Create new review
export const createProductReview = asyncMiddleware(async (req, res, next) => {
...
// Get Product Reviews
export const getProductReviews = asyncMiddleware(async (req, res, next) => {
...
export const deleteReview = asyncMiddleware(async (req, res, next) => {
